...
- [ALT-NO](https://www.altno.ca/)
- [Hawkesbury on Track](https://thereview.ca/2026/02/27/hawkesbury-on-track-making-case-for-local-alto-stop/)
- Governement of Canada 
  - [Debates of the Senate](https://publications.gc.ca/collections/collection_2026/sen/y3/Y3-451-55-eng.pdf)
  - [Hansard Monday, March 9, 2026](https://www.noscommunes.ca/documentviewer/fr/45-1/chambre/seance-92/debats)
  - [Hansard Thursday, February 5, 2026](https://www.noscommunes.ca/documentviewer/en/45-1/house/sitting-80/hansard)

The concerns raised including the following:

- adequate consultation
- no local economic benefit
- integrity of recreational trail networks
...
<div class="callout">
  <h2>Next step</h2>
  <p>A multimodal pathway cannot address all of these concerns, but it can help with some.</p>
  <p><a class="button button-primary" href="{{ '/issues-and-solutions/how-the-trail-helps/' | relative_url }}">How the Trail Helps</a></p>
</div>
